...
public class IPAddressValidator_4 {

    public static void main(String[] args) {
        String ipAddress = "235.168.1.1";  // корректный IP адрес
    ...
    public static boolean isValidIPAddress(String ipAddress) {
        ...
        // регулярные выражения для проверки IP адреса
        ...
        try {
            ...
            // проверка соответствия IP адреса регулярным выражениям
            if (!matcher.matches()) {
